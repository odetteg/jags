...
declare -A snakemake_output=( [0]="/Users/sg/Documents/micromake/results/data/ERR246969_R2.fastq" )
declare -A snakemake_params=( )
declare -A snakemake_wildcards=( [0]="ERR246969_R2.fastq" [sample]="ERR246969_R2.fastq" )
