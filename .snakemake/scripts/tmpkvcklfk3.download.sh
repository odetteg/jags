...
declare -A snakemake_output=( [0]="/Users/sg/Documents/micromake/results/data/ERR246975_R1.fastq" )
declare -A snakemake_params=( )
declare -A snakemake_wildcards=( [0]="ERR246975_R1.fastq" [sample]="ERR246975_R1.fastq" )
